...
import { User, IFavorites, IFavoritesProducts, IProductToFavorites } from 'src/app/_models';
...
export class FavoritesSelListComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<FavoritesSelListComponent>,
              @Inject(MAT_DIALOG_DATA) public data: { productToFavorites: IProductToFavorites, user: User},
  ...
  ngOnInit() {
    this.product = this.data.productToFavorites;
